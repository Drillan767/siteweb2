...
class PortfoliosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create portfolio" do
    assert_difference('Portfolio.count') do
      post portfolios_url, params: { portfolio: { categorie: @portfolio.categorie, description: @portfolio.description, public: @portfolio.public, slug: @portfolio.slug, thumbnail: @portfolio.thumbnail, titre: @portfolio.titre } }
    end
